...
@pytest.mark.parametrize(
    ...
    [
        ...
        ([{"id": 1, "state": "PENDING"}], []),
        (
            [{"id": 1, "state": "EXECUTED"}, {"id": 2, "state": "EXECUTED"}, {"id": 3, "state": "CANCELED"}],
            ["EXECUTED", "EXECUTED"],
        ),
        ([], []),
    ],
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            [{"date": "2020-01-01T00:00:00Z"}, {"date": "2019-01-01T00:00:00Z"}, {"date": "2021-01-01T00:00:00Z"}],
            False,
        ...
        (
            [{"date": "2020-01-01T00:00:00Z"}, {"date": "2020-01-01T00:00:00Z"}, {"date": "2021-01-01T00:00:00Z"}],
            True,
